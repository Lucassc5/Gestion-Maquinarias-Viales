            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <a href="{{Route('viewMachine')}}">Atras</a>
                        ...
                        <form action="{{ route('storeMachine') }}" method="POST">
                        @csrf
                        ...
                        <div>
                            ...
                            <select name="type" id="type"
                                    class="mt-1 block w-full rounded-md dark:bg-gray-900 dark:text-white border-gray-300 shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                                    <option value="" disabled selected>Type Machines</option>
                        ...
                        <div>
                            ...
                            <input type="number" name="model" id="model" placeholder="Machine Model"
                                   class="mt-1 block w-full rounded-md dark:bg-gray-900 dark:text-white border-gray-300 shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                        </div>

                        <div class="flex justify-end">
                            <button type="submit"
                                    class="px-4 py-2 bg-indigo-600 text-white rounded-md hover:bg-indigo-700 transition">Save Machine</button>
                        </div>
                    </form>
